...
// AnnouncementBar no longer manages its own visibility — parent controls it
...
export const Navbar = ({ onOpenCart, cartCount }: { onOpenCart: () => void; cartCount: number }) => {
  ...
  return (
    // ← Fixed positioning removed here; parent wrapper in App.tsx handles it
    <nav className={cn(
            ...
            >
              <input
                ...
                className={cn(
                  ...
                  scrolled ? "border-brand-charcoal/30" : "border-white/40 placeholder:text-white/50"
                )}
              />
            </motion.div>
          )}
