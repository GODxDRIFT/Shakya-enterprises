...
export const PRODUCTS: Product[] = [
  ...
  { id:'5', name:'Linen Table Runner', category:'Runners', price:'$24', priceINR:'₹1,999', image:'https://cdn.swadeshonline.com/v2/patient-paper-41f385/swad-p/wrkr/products/pictures/item/free/resize-w:700/swadesh/471011427/1/v0kIR37dWu-471011427001_1_LS.jpg', description:'Block-print runner for modern dining.', details:['14×72 inch','Block-print border','Heat resistant'], materials:'100% pure linen', care:'Machine wash delicate cycle' },
